...
export const slider: RegistryEntry = {
  name: "slider",
  type: "components:ui",
  description: "Accessible range slider for selecting a numeric value.",
  dependencies: [
  ...
  files: [
    {
      path: "components/ui/slider.primitive.tsx",
      content: primitiveContent,
      type: "registry:ui",
      target: "components/ui/slider.primitive.tsx",
    },
    {
  ...
  meta: {
    importSpecifier: "Slider",
    moduleSpecifier: "@/components/ui/slider",
  },
};
